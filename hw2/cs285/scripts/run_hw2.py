...
def run_training_loop(args):
    ...
    for itr in range(args.n_iter):
        ...
        # sample_trajectory(env: gym.Env, policy: MLPPolicy, max_length: int, render: bool = False)

        trajs, envsteps_this_batch = utils.sample_trajectories(env, agent.actor, args.batch_size, 
                                                               max_ep_len, args.video_log_freq)  # TODO
